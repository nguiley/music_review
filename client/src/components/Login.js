    ...
    return (
        <div className='login-page'>
            ...
            <form onSubmit={onSubmit}>
                ...
                <button type="submit" disabled={isSigningIn}>{isSigningIn ? "Logging In..." : "Log In"}</button>
                <p className='error'>{errorMessage ? `${errorMessage}` : ''}</p>
                <div class="social">
                    <div class="go"><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png' alt='Google' height={50} onClick={(e) => { onGoogleSignIn(e) }}/></div>
                </div>
                <p className="text-center text-sm">Don't have an account? <Link to={'/RegisterPage'} className="hover:underline font-bold">Sign up</Link></p>
            </form>
